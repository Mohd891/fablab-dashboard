(function(){
  ...
  function init(){
    ...
    document.body.appendChild(launch);document.body.appendChild(panel);messages=panel.querySelector('.ai-chat-messages');input=panel.querySelector('.ai-chat-input');send=panel.querySelector('.ai-chat-send');
    panel.querySelector('.ai-chat-close').addEventListener('click',function(){panel.classList.remove('open');document.body.classList.remove('ai-chat-page-open');});
    launch.addEventListener('click',function(){panel.classList.toggle('open');document.body.classList.toggle('ai-chat-page-open',panel.classList.contains('open'));if(panel.classList.contains('open'))input.focus();});
