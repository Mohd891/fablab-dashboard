(function(){
  ...
  function addStyles(){
    ...
    s.textContent=''
      ...
      +'.ai-chat-messages{min-height:0;overflow-y:auto;overflow-x:hidden;padding:15px;background:#f7f9fc;display:flex;flex-direction:column;justify-content:center;gap:10px;position:relative;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scroll-behavior:smooth}'
      +'.ai-chat-messages:not(.has-conversation){overflow:hidden}.ai-chat-messages:not(.has-conversation) .ai-msg.bot{position:absolute;left:12px;right:12px;top:50%;transform:translateY(-50%);align-self:auto;max-width:none;margin:0}'
      +'.ai-chat-messages.has-conversation{justify-content:flex-start}.ai-chat-messages.has-conversation .ai-msg.bot{position:static;transform:none;align-self:flex-start;max-width:85%}'
      +'.ai-msg{max-width:85%;padding:10px 12px;border-radius:14px;font-size:12px;line-height:1.8;white-space:pre-wrap;overflow-wrap:anywhere;flex:0 0 auto}.ai-msg.bot{align-self:flex-start;background:#fff;border:1px solid #e5eaf1;color:#253348;border-bottom-left-radius:5px}.ai-msg.user{align-self:flex-end;background:#2865df;color:#fff;border-bottom-right-radius:5px}.ai-msg.typing{color:#7b8798}'
      +'.ai-chat-suggestions{display:flex;gap:7px;overflow-x:auto;overflow-y:hidden;padding:9px 11px;background:#fff;border-top:1px solid #edf0f4;scrollbar-width:none;z-index:3;flex:0 0 auto}.ai-chat-suggestions::-webkit-scrollbar{display:none}.ai-suggest{border:1px solid #dfe6ef;background:#f8fafc;color:#536176;border-radius:999px;padding:7px 10px;font-size:10px;white-space:nowrap;cursor:pointer;flex:0 0 auto}.ai-suggest:hover{border-color:#2865df;color:#2865df}'
      +'.ai-chat-form{display:flex;gap:8px;padding:10px;background:#fff;border-top:1px solid #e8edf3;z-index:3;flex:0 0 auto}.ai-chat-input{flex:1;min-width:0;border:1px solid #dce3eb;border-radius:11px;padding:10px 12px;outline:none;font-size:16px;background:#fff}.ai-chat-input:focus{border-color:#2865df}.ai-chat-send{width:43px;flex:0 0 43px;border:0;border-radius:11px;background:#2865df;color:#fff;cursor:pointer;font-size:17px}.ai-chat-send:disabled{opacity:.55;cursor:not-allowed}'
