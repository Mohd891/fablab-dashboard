document.addEventListener('DOMContentLoaded',function(){
  ...
  var data=[
    ['صناع المستقبل','Innovation','معسكر إثرائي تفاعلي في العلوم والتقنية والابتكار.'],
    ['صناع الواقع','Digital Fabrication','تحويل الأفكار إلى منتجات حقيقية باستخدام تقنيات التصنيع الرقمي.'],
    ['الروبوتات الذكية','Smart Robotics','مشاريع عملية تجمع الزراعة الذكية والإلكترونيات والبرمجة.'],
    ['روبوتات VEX العالمية','VEX Robotics','تصميم وبناء وبرمجة روبوتات VEX وفق معايير المسابقات العالمية.']
  ];
  ...
  if(grid){
    ...
    var more=document.createElement('div');more.className='programs-more';more.innerHTML='<a class="btn primary large" href="programs.html">اكتشف المزيد من البرامج ←</a>';grid.parentNode.insertBefore(more,grid.nextSibling);
  }
